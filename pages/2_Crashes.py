...
def show_gif_with_text(gif_path, display_time=2):
    """
    ...
    placeholder.empty()
show_gif_with_text("pages/planeCrash.gif", display_time=3)
...
def load_data():
    ...
    data = pd.read_csv('pages/Plane Crashes.csv')
    return data
...
df, available_year_groups = load_and_process_data('pages/Plane Crashes.csv')
